  ...
  return (
    <header className="sticky top-0 flex w-full bg-white border-gray-200 z-50 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-4">
        <div className="flex items-center justify-between w-full gap-2 px-2 py-2 border-b border-gray-200 dark:border-gray-800 sm:gap-3 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-3">
          <button
            className="items-center justify-center w-8 h-8 text-gray-500 border-gray-200 rounded-lg z-50 dark:border-gray-800 lg:flex dark:text-gray-400 lg:h-10 lg:w-10 lg:border"
          ...
          <Link href="/" className="lg:hidden flex gap-2 items-center">
            <Image
              className=""
