...
import { addCampaignAsync } from '@/lib/redux/features/campaigns/campaignsSlice';
import { useAppDispatch } from '@/lib/redux/hooks';
import { TypeCampaignStatus, TypeCampaign } from '@/types/form';
...
export default function NewCampaignPage() {
    ...
    const onSubmit = async (data: FormValues) => {
        ...
        try {
            ...
            await dispatch(addCampaignAsync(metadata)).unwrap();
